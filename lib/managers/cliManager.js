...
module.exports = EventDispatcher.define({
    $config: {
        ...
        inject: [ 'utils', 'env', 'swampServicesManager' ]
    },
    ...
    _onCliClientRestartAllRunning: function(data, client) {
        ...
        var msg = 'all running swamp services restarted.';
        var type = 'success';
    ...
    _onCliClientStopAllRunning: function(data, client) {
        ...
        var msg = 'all running swamp services stopped.';
        var type = 'success';
    ...
    _onCliClientStartAll: function(data, client) {
        ...
        var msg = 'all swamp services started.';
        var type = 'success';
    ...
    _onCliClientStateAll: function(data, client) {
        ...
        _.forEach(services, function(service) {
            ...
            status =  service.isRunning ? 'running'['green'] : 'not running'['red'];
