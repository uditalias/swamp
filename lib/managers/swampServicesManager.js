...
module.exports = EventDispatcher.define({
    ...
    autoRun: function() {
        ...
        if(this.count() == 0) {
            this.utils.log('No services found in the Swamp', this.utils.LOG_TYPE.INFO, false, false, this.mainLoggersManager.getOut());
            return;
        }
        ...
        if(!runningServices) {
            this.utils.log('No services configured to autorun', this.utils.LOG_TYPE.INFO, false, false, this.mainLoggersManager.getOut());
        }
    ...
    restartAllRunning: function() {
        ...
        _.forEach(this.getAll(), function(service) {
            ...
            if(service.isRunning) {
                service.restart(service.runningEnvironment);
            }
    ...
    startAll: function() {
        ...
        _.forEach(this.getAll(), function(service) {
            ...
            service.start(service.runningEnvironment);
