...
module.exports = EventDispatcher.define({
    ...
    stopAllRunning: function() {
        ...
        _.forEach(this.getAll(), function(service) {
            ...
            if(service.getOption.isRunning) {
                service.stop();
            }
    ...
    _bindServiceEvents: function(service) {
        service.on('start', this.fireEvent.bind(this));
        service.on('stop', this.fireEvent.bind(this));
        service.on('restart', this.fireEvent.bind(this));
        service.on('stderr', this.fireEvent.bind(this));
        service.on('stdout', this.fireEvent.bind(this));
    },
