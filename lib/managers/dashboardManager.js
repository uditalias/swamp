...
module.exports = EventDispatcher.define({
    ...
    _launchWebServer: function() {
        ...
        var port = this.optionsManager.getOptions().dashboard.port;
        var credentials = this._getAuthCredentialsMechanism();
    ...
    _getAuthCredentialsMechanism: function() {

        var basicAuthCredentials = {};
        var userConfigCredentials = this.optionsManager.getOptions().dashboard.credentials;

        if(userConfigCredentials) {

            if(userConfigCredentials instanceof Array) {

                basicAuthCredentials = this.basicAuthManager.getBasicAuthMiddleware();

            } else {
                basicAuthCredentials = userConfigCredentials;
            }
    ...
    dispose: function() {
        ...
        _.forEach(this._clients, this.disposeClient);

    },

    disposeClient: function(client) {
