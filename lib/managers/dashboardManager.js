...
module.exports = EventDispatcher.define({
    ...
    _sendSwampInitialData: function(clientId) {
        ...
        if(client) {
            ...
            client.sendMessage({ event: 'swamp.initialData', data: services });
        }
    },
    ...
    _onSwampServiceRestarted: function(evt, serviceName) {
        this.broadcast({ event: 'service.restart', data: serviceName });
    },

    _onSwampServiceError: function(evt, serviceName, data) {
        this.broadcast({ event: 'service.error', data: { name: serviceName, error: data } });
    },

    _onSwampServiceOut: function(evt, serviceName, data) {
        this.broadcast({ event: 'service.out', data: { name: serviceName, out: data } });
    }
