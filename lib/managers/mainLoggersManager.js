...
module.exports = Class.define({
    ...
    _initializeLoggers: function(logs) {
        ...
        this._loggers = {
            out: this._createLogger({ filename: _logFilesPath.out, json: false, maxSize: _logFilesSize.out, maxFiles: _logFilesMax.out }, true, true, 100, true, false),
            err: this._createLogger({ filename: _logFilesPath.err, json: false, maxSize: _logFilesSize.err, maxFiles: _logFilesMax.err }, true, true, 100, true, false)
        }
    },
