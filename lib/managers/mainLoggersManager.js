...
module.exports = Class.define({
    ...
    _initializeLoggers: function(logs) {
        ...
        this._loggers = {
            out: this._createLogger({ filename: _logFilesPath.out, json: false, maxSize: _logFilesSize.out }, true, 100, true),
            err: this._createLogger({ filename: _logFilesPath.err, json: false, maxSize: _logFilesSize.err }, true, 100, true)
        }
    },
