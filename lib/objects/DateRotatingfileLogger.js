...
//
var DateRotatingFileLogger = exports.DateRotatingFileLogger = function (options) {
    ...
    this.rotationFormat = options.rotationFormat || function () {
...
//
util.inherits(DateRotatingFileLogger, Transport);

//
// Expose the name of this Transport on the prototype
//
DateRotatingFileLogger.prototype.name = 'DateRotatingFileLogger';
...
//
DateRotatingFileLogger.prototype.log = function (level, msg, meta, callback) {
    if (this.silent) {
...
//
DateRotatingFileLogger.prototype._write = function (data, callback) {
    if (this._isStreams2) {
...
//
DateRotatingFileLogger.prototype.query = function (options, callback) {
...
//
DateRotatingFileLogger.prototype.stream = function (options) {
    var file = path.join(this.dirname, this.filename),
        options = options || {},
        stream = new Stream;
...
//
DateRotatingFileLogger.prototype.open = function (callback) {
    var now = new Date();
    if (this.opening) {
        //
...
//
DateRotatingFileLogger.prototype.close = function () {
    var self = this;
...
//
DateRotatingFileLogger.prototype.flush = function () {
    var self = this;
...
//
DateRotatingFileLogger.prototype._createStream = function () {
    var self = this;
    this.opening = true;
...
DateRotatingFileLogger.prototype._incFile = function (callback) {
...
//
DateRotatingFileLogger.prototype._getFile = function () {
    var ext = path.extname(this._basename),
        basename = path.basename(this._basename, ext);
...
//
DateRotatingFileLogger.prototype._checkMaxFilesIncrementing = function (ext, basename, callback) {
    var oldest, target;
...
DateRotatingFileLogger.prototype._checkMaxFilesTailable = function (ext, basename, callback) {
    var tasks = [],
        self = this;
...
//
DateRotatingFileLogger.prototype._lazyDrain = function () {
    var self = this;
