...
module.exports = EventDispatcher.define({
    ...
    constructor: function(service){
        ...
        this._phase = this.SERVICE_PHASE.NONE;
    ...
    start: function(envName) {
        ...
        if(!this.isRunning && this._phase != this.SERVICE_PHASE.STARTING && this._phase != this.SERVICE_PHASE.STARTED) {

            this._phase = this.SERVICE_PHASE.STARTING;
    ...
    stop: function() {
        ...
        if(this.isRunning && this._phase != this.SERVICE_PHASE.STOPPING && this._phase != this.SERVICE_PHASE.STOPPED) {

            this._phase = this.SERVICE_PHASE.STOPPING;
            ...
            this._phase = this.SERVICE_PHASE.STOPPED;
    ...
    _onProcessRun: function() {
        ...
        this._phase = this.SERVICE_PHASE.STARTED;
