...
module.exports = EventDispatcher.define({
    ...
    _onProcessTree: function(children) {
        ...
        child_process.spawn('kill', ['-9'].concat(children.map(function (p) { return p.PID })));
    ...
    _initializeLoggers: function(logs) {
        ...
        this._loggers = {
            out: this._createLogger({ filename: _logFilesPath.out, json: false, maxSize: _logFilesSize.out, maxFiles: _logFilesMax.out }, true, true, this._options.maxLogsToSave, false, true),
            err: this._createLogger({ filename: _logFilesPath.err, json: false, maxSize: _logFilesSize.err, maxFiles: _logFilesMax.err }, true, true, this._options.maxLogsToSave, false, true)
        }
