...
module.exports = EventDispatcher.define({
    ...
    /*
     *  Serialize this service options for connected dashboard clients
     */
    serialize: function() {
        return {
            name: this.name,
    ...
    /*
     *  Returns this service options configured in the Swampfile
     */
    ...
    _onWatcherEvent: function(err, changelog) {
        ...
        if(err) {
            this.utils.log(this.LOG_TEMPLATES.RESTART_ON_CHANGE_ERROR.format(err.toString()), this.utils.LOG_TYPE.ERROR, false, false, this._loggers.err);
