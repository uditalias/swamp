...
module.exports = EventDispatcher.define({
    ...
    _initializeLoggers: function(logs) {
        ...
        this._loggers = {
            out: this._createLogger({ filename: _logFilesPath.out, json: false, maxSize: _logFilesSize.out }, true, true, this._options.maxLogsToSave, false),
            err: this._createLogger({ filename: _logFilesPath.err, json: false, maxSize: _logFilesSize.err }, true, true, this._options.maxLogsToSave, false)
        }
