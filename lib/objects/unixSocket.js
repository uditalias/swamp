...
module.exports = EventDispatcher.define({
    ...
    _onServerError: function(err) {
        ...
        this.utils.log(error, this.utils.LOG_TYPE.ERROR, false, false, this.mainLoggers.err);
    ...
    _onServerListenStart: function() {
        ...
        this.utils.log('Unix socket file `{0}` established'.format(this._path), this.utils.LOG_TYPE.SUCCESS, false, false, this.mainLoggers.out);
